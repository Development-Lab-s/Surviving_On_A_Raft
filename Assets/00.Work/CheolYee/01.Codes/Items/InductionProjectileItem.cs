...
{
    public class InductionProjectileItem : ItemTypeProjectile
    {
        [Header("Induction Projectile Item")]
        ...
        protected override void SpawnProjectile()
        {
            ...
            if (target != null)
            {
                ...
                if (projectile != null)
                    projectile.Initialize(transform, target.gameObject.transform, Damage + Player.CurrentDamage, KnockbackPower, Speed);
            }
            else
            {
