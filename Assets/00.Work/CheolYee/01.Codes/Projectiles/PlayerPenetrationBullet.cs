...
{
    public class PlayerPenetrationBullet : Projectile
    {
        ...
        public override void Initialize(Transform firePos, Vector2 mousePos, float damage, float knockbackPower, float shotSpeed)
        {
            _damage = damage; //데미지
        ...
        {
            RbCompo.linearVelocity = _direction * _speed; //방향으로 날아가기
